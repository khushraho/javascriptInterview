/**
 *! six and seven file is connected with each other in this only type==(text,image,card,carousel) worked*/
  ...
  for (const key in inputData) {
    ...
    if (value.message) {
      ...
      convertedValue.richCard = {
        standaloneCard: {
          cardContent: {
            title: value.card.standaloneCard.cardContent.title,
            description: value.card.standaloneCard.cardContent.description,
            media: {
              height: value.card.standaloneCard.cardContent.media.height,
              contentInfo: {
                fileUrl:
                  value.card.standaloneCard.cardContent.media.contentInfo
                    .fileUrl,
                forceRefresh:
                  value.card.standaloneCard.cardContent.media.contentInfo
                    .forceRefresh,
            ...
            suggestions: value.card.standaloneCard.cardContent.suggestions.map(
              (suggestion) => ({
                reply: {
                  text: suggestion.text,
                  postbackData: suggestion.postbackData,
